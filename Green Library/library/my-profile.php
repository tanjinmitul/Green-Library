...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>GreenLibrary  | Student Signup</title>
...
<input class="form-control" type="number" name="mobileno" maxlength="11" value="<?php echo htmlentities($result->MobileNumber);?>" autocomplete="off" required />
</div>
